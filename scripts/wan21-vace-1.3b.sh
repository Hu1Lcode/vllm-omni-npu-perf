#!/usr/bin/env bash
# ============================================================
# Wan2.1-VACE-1.3B —— 部署推理脚本
# 系列: Wan 2.1 系列 ｜ 组织: Wan-AI ｜ 仓库: Wan-AI/Wan2.1-VACE-1.3B-diffusers
# 任务: 文生视频 / 图生视频
...
# 注: 官方 recipe 未提供专用 serve 命令；在线服务使用标准 --omni 入口（vllm serve Wan-AI/Wan2.1-VACE-1.3B-diffusers --omni）。
