...
| NPU 支持 | 支持 |
| 模型权重 | [HuggingFace](https://huggingface.co/Wan-AI/Wan2.1-I2V-14B-720P) · [ModelScope](https://modelscope.cn/models/Wan-AI/Wan2.1-I2V-14B-720P) |

## 模型介绍

**Wan2.1-I2V-14B-720P** 是 Wan 2.1 的图生视频模型：输入一张参考图像 + 文本提示词，生成与之语义一致的 720P 视频。
...
- [HuggingFace · Wan2.1-I2V-14B-720P](https://huggingface.co/Wan-AI/Wan2.1-I2V-14B-720P)
